...
{
    public class ProfilePresentationManagerVM : ViewModelBase
    {
        ...
        public ICommand SaveProfileChangesCommand
        {
            get
            {
                return saveProfileChangesCommand ??= new Commands.DelegateCommand(obj =>
                {
                    ...
                    ManagerDto testUser = new ManagerDto
                    {
                        FirstName = FirstName,
                        LastName = LastName,
                        Surname = Surname,
        ...
        public ProfilePresentationManagerVM(IAuthenticator authenticator)
        {
            ...
            Login = userDTO.Login;
            Phone = ((ManagerDto)userDTO).Phone;
            Email = ((ManagerDto)userDTO).Email;
        }
    }
}
